...
public class EntityRenderer implements IResourceManagerReloadListener
{
     ...
     */
    protected final DynamicTexture lightmapTexture;
    /**
     * Colors computed in updateLightmap() and loaded into the lightmap emptyTexture
     */
    protected final int[] lightmapColors;
    ...
    protected float bossColorModifier;
    protected float bossColorModifierPrev;
    /** Cloud fog mode */
     ...
     */
    protected boolean lightmapUpdateNeeded;
    /** Torch flicker X */
    protected float torchFlickerX;
    /** Torch flicker DX */
     ...
     */
    protected float getNightVisionBrightness(EntityPlayer p_82830_1_, float p_82830_2_)
    {
