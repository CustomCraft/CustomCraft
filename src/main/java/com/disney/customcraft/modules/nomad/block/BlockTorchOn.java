package com.disney.customcraft.modules.nomad.block;
...
import com.disney.customcraft.modules.nomad.block.itemblock.ItemBlockTorchOff;
import com.disney.customcraft.modules.nomad.block.itemblock.ItemBlockTorchOn;
...
public class BlockTorchOn extends BlockContainer {
	
	public TorchMaterial material;
	private String itemName;
		
	public BlockTorchOn(TorchMaterial material, String itemName) {
		super(Material.wood);
	...
	private void register() {
		GameRegistry.registerBlock(this, ItemBlockTorchOn.class, getUnlocalizedName() + "." + itemName + "On");
		GameRegistry.registerTileEntity(TileTorch.class, getUnlocalizedName() + ".tile" + itemName + "On");
	...
	protected void dropBlockAsItem(World world, int x, int y, int z, ItemStack item) {
		ItemStack torchOff = new ItemStack(ModuleNomad.blockTorchOff[material.getMeta()]);
	...
	public void registerBlockIcons(IIconRegister register) {
		blockIcon = register.registerIcon("customcraft:nomad/" + itemName);
	}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileTorch(material.getMaxDura());
	}
}
