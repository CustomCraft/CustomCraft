...
public class BlockTorchOff extends Block {
	...
	public BlockTorchOff(TorchMaterial material, String itemName) {
		super(Material.wood);
	...
	private void register() {
		GameRegistry.registerBlock(this, ItemBlockTorchOff.class, getUnlocalizedName() + "." + itemName + "Off");
    ...
    public static enum TorchMaterial {
        WOOD("wood", 0, 180),
        COAL("coal", 1, 360),
        WAX("wax", 2, 720),
        OIL("oil", 3, 2160);
        ...
        private TorchMaterial(String name, int meta, int maxDura) {
            this.name = name;
            this.meta = meta;
