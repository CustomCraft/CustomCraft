...
public class FancyItemEntity extends EntityItem
{
    public FancyItemEntity(World par1World, double par2, double par4, double par6)
    {
    ...
    public FancyItemEntity(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack)
    {
    ...
    public FancyItemEntity(World par1World)
    {
        super(par1World);
        this.isImmuneToFire = true;
        this.lifespan = 72000;
    ...
    public FancyItemEntity(World world, Entity original, ItemStack stack)
    {
