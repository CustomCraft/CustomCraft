...
public class BlockTorchOn extends BlockContainer {
	...
	private void register() {
		GameRegistry.registerBlock(this, ItemBlockTorchOn.class, getUnlocalizedName() + "On");
		GameRegistry.registerTileEntity(TileTorch.class, getUnlocalizedName() + "Tile");
		
		CustomCraft.proxy.registerSimpleRenderer(this);
	}
	
	public void setTorchMaterial(TorchMaterial material) {
		this.material = material;
	}
	
	public TorchMaterial getTorchMaterial() {
		return material;
	}
	...
	public void registerBlockIcons(IIconRegister register) {
		blockIcon = Blocks.torch.getIcon(0, 0);
	}
