...
public class BlockTorchOff extends Block {
	...
	private void register() {
		GameRegistry.registerBlock(this, ItemBlockTorchOff.class, getUnlocalizedName() + "Off");
	...
	public void registerBlockIcons(IIconRegister register) {
		blockIcon = register.registerIcon(ItemHelper.getIconLoc(getUnlocalizedName()));
	}
